...
function Booths() {
    ...
    const Modal = ({index, booth_sku, title}) => {
        return (
                        ...
                        <div className="modal-body">
                            <table className={'table'}>
                                ...
                                <>
                                            ...
                                            booth_sku.map((sku) => (
                                                <tr key={sku.id}>
                                                    <td className={'text-left'}>
                                                        {sku.skucode}
                                                        <br/>
                                                        <span className={'text-sm text-secondary'}>{sku.skuname}</span>
                                                    </td>
                                                    <td>
                                                        <input type="number" className={'form-control'}
                                                               defaultValue={sku.skuqty}/></td>
                                                    <td>
                                    ...
                                    <tr>
                                        <td colSpan={3}>
                                            <ButtonComponent Icon={'fa-plus'} title={'เพิ่ม'}/>
                                        </td>
                                    </tr>
                                </>
                                            ...
                                            booths.map((booth, index) => (
                                                <tr key={booth.id}>
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp;
                                                        <ButtonComponent onClick={()=>Delete(booth.id)} Icon={'fa-trash'} BtnStyle={'btn-sm bg-danger'}/>
                                                        <Modal index={index} booth_sku={booth.get_booth_sku} title={`${booth.startdate} ถึง ${booth.enddate}`}/>
                                                    </td>
                                                </tr>
                                            ))
                                        ) : (
